    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2022 Online Food Order system | <a href="Developer Akash Chauhan" target="_blank">Developer Akash Chauhan</a></div></div>
        </footer>
